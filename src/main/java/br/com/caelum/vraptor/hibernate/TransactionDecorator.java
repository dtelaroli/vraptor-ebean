...
/**
 * Decorator to {@link EbeanTransactionInterceptor}
 * 
 * @author Denilson Telaroli
 */

@Decorator
public class TransactionDecorator implements EbeanInterceptor {

	private final EbeanInterceptor delegate;
	...
	@Inject
	public TransactionDecorator(@Delegate @Any EbeanInterceptor delegate, ControllerMethod method) {
